...
class BiWeeklyStrategyTest {

    @Mock
    private MonthlyPaymentCalculator monthlyPaymentCalculator;

    @InjectMocks
    private BiWeeklyStrategy strategy;

    @Test
    void getPaymentScheduleType() {
        // expected
        PaymentScheduleType expected = PaymentScheduleType.BI_WEEKLY;
    ...
    void calculatePayment() {
        ...
        // expected
        BigDecimal expected = new BigDecimal("6.46");
